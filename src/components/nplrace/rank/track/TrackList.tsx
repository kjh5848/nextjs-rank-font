        ...
        <div className="rounded-lg bg-white">
          <div className="border-b bg-gradient-to-r from-white to-blue-50 px-3 py-3 sm:px-6">
            <div className="grid grid-cols-12 gap-2 sm:gap-4">
              ...
              <div className="col-span-2 text-xs font-bold text-gray-500 uppercase sm:col-span-1">
                No.
              </div>
              <div className="col-span-2 hidden text-xs font-bold text-gray-500 uppercase sm:block">
                그룹
              </div>
              <div className="col-span-3 text-xs font-bold text-gray-500 uppercase sm:col-span-2">
                이미지
              </div>
              <div className="col-span-6 text-xs font-bold text-gray-500 uppercase">
                플레이스 / 순위
              </div>
            </div>
          </div>
            ...
            {filteredShopList.map((thisShop) => (
              <div
                ...
                className={`cursor-pointer border-b border-gray-100 px-3 py-4 transition-all duration-200 hover:bg-blue-50 sm:px-6 ${
                  selectedShopList.has(thisShop.id) ? "bg-blue-50" : "bg-white"
                }`}
                  ...
                  <div className="grid grid-cols-12 items-center gap-2 sm:gap-4">
                    ...
                    <div className="col-span-6">
                      ...
                      {thisShop.nplaceRankTrackInfoList.length === 0 ? (
                        ...
                        thisShop.nplaceRankTrackInfoList.map(
                          (thisInfo: any) => (
                            <div
